...
@php
    $name_petugas =Session::get('name_petugas');
        ...
        <nav id="sidebar" class="sidebar js-sidebar">
            <div class="sidebar-content js-simplebar">
                <a class="sidebar-brand" href="index.html">
                    <span class="align-middle">WPM</span>
                </a>
                    ...
                    <ul class="navbar-nav navbar-align">
                        <li class="nav-item dropdown">
                            ...
                            <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#"
                                data-bs-toggle="dropdown">
                                <img src="https://ui-avatars.com/api/?name={{ $name_petugas }}?background=random" class="avatar img-fluid rounded me-1"
                                    alt="Jhoni Jhon" /> <span class="text-dark">
                                        {{ $name_petugas }}
                                    </span>
                            </a>
